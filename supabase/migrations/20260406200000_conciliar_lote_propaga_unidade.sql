-- ============================================================
-- FIX: conciliar_lote agora propaga unidade_destino_id
-- para contas_pagar, contas_receber e movimentacoes
-- ============================================================
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Se não veio no payload, tentar buscar da bank_transaction
  ...
  -- Atualizar current_balance da conta bancária

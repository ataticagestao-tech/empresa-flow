                ...
                <div className="border border-[#ccc] rounded-lg overflow-hidden bg-white shrink-0 mb-3">
                  <div className="bg-[#071D41] px-4 py-3 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <RoleGate minRole="operador"><button onClick={handleNew} className="text-[11px] font-bold text-white/70 hover:text-white border border-white/40 hover:bg-white/20 rounded px-2 py-1 ml-1">+ Novo</button></RoleGate>
                    </div>
                  </div>
                </div>

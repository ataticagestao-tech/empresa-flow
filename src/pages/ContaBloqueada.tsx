      ...
      <Card className="w-full max-w-2xl shadow-xl border-slate-200">
        ...
        <CardContent className="space-y-5">
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
            <p className="text-sm font-semibold text-slate-700">Motivo informado pela administração</p>
            <p className="mt-2 text-sm text-slate-700">{reasonText}</p>
            {updatedAtText && (
              <p className="mt-2 text-xs text-slate-500">Atualizado em: {updatedAtText}</p>
            )}
          </div>

          <div className="rounded-lg border border-slate-200 bg-white p-4">
            <p className="text-sm font-semibold text-slate-700">Suporte da plataforma</p>
            <a

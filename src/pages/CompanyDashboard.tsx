                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 14, marginBottom: 16 }}>
                    ...
                    <div className="kpi-card" style={{ ...billoraCard, padding: 20, display: "flex", flexDirection: "column", gap: 10}}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            ...
                            <div style={{ fontSize: 22, fontWeight: 700, color: C.text1, letterSpacing: "-0.015em", lineHeight: 1.15, whiteSpace: "nowrap", display: "inline-flex", alignItems: "center", gap: 6 }}>
                        ...
                        <div style={{ fontSize: "clamp(26px, 2.4vw, 34px)", fontWeight: 800, color: C.text1, lineHeight: 1, letterSpacing: "-0.03em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", fontVariantNumeric: "tabular-nums" }}>{fmt(receitaPeriodo)}</div>
                    ...
                    <div className="kpi-card" style={{ ...billoraCard, padding: 20, display: "flex", flexDirection: "column", gap: 10}}>
                        ...
                        <div style={{ fontSize: "clamp(26px, 2.4vw, 34px)", fontWeight: 800, color: C.text1, lineHeight: 1, letterSpacing: "-0.03em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", fontVariantNumeric: "tabular-nums" }}>{fmt(despesaPeriodo)}</div>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: C.textMuted, marginTop: 2 }}>
                    ...
                    <div className="kpi-card" style={{ ...billoraCard, padding: 20, display: "flex", flexDirection: "column", gap: 10}}>
                        ...
                        <div style={{ fontSize: "clamp(26px, 2.4vw, 34px)", fontWeight: 800, color: resultadoPeriodo >= 0 ? "#039855" : "#E53E3E", lineHeight: 1, letterSpacing: "-0.03em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", fontVariantNumeric: "tabular-nums" }}>{fmt(resultadoPeriodo)}</div>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: C.textMuted, marginTop: 2 }}>

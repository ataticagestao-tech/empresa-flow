            ...
            <div className="space-y-6 animate-fade-in">
                        ...
                        {selectedSearch && (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <Card className="border-dashed">
                                    ...
                                    <CardContent>
                                        <div className="text-2xl font-bold text-[#E53E3E] flex items-center gap-2">
                                ...
                                <Card className="border-dashed">
                                    ...
                                    <CardContent>
                                        <div className={cn("text-2xl font-bold flex items-center gap-2", arapSummary.net >= 0 ? "text-blue-600" : "text-[#E53E3E]")}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div
                                className={`text-2xl font-bold flex items-center gap-2 ${summary.net >= 0 ? "text-blue-600" : "text-[#E53E3E]"}`}
                            >
                                <TrendingUp className="h-6 w-6" />
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className={`text-2xl font-bold flex items-center gap-2 ${summary.net >= 0 ? "text-blue-600" : "text-[#E53E3E]"}`}>
                                    <TrendingUp className="h-6 w-6" />
                                    {formatCurrency(summary.net)}
                                </div>
                            </CardContent>

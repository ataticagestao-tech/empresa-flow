...
export function SupplierHistoryDialog({ open, onOpenChange, supplier }: Props) {
    ...
    const { data: pagamentos = [], isLoading } = useQuery({
        ...
        enabled: !!supplier?.id && !!selectedCompany?.id && open,
    });
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <Button size="sm" onClick={gerarPDF} disabled={gerandoPDF} className="shrink-0">
                ...
                <div className="border border-[#ccc] rounded-lg overflow-hidden mt-4">
